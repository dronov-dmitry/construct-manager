const translations = {
  en: {
    ...
    "deploy.keys.text": "In Settings → API copy Project URL and anon public key. Paste them in the ConstructManager settings screen.",
  ...
  de: {
    ...
    "deploy.keys.text": "Kopieren Sie unter Settings → API die Project URL und den anon public key. Fügen Sie beides in den ConstructManager-Einstellungen ein.",
  ...
  ru: {
    ...
    "deploy.keys.text": "В Settings → API скопируйте Project URL и anon public key. Вставьте их в экран настроек ConstructManager.",
